...
metadata_W300_lane1 <- pData(W300_lane1)
head(metadata_W300_lane1)
...
library(Matrix)
#counts
writeMM(sce_filtered.filt.counts, "~/Lab_Data/SoupX/Waterson_300_lane1/filtered_feature_bc_matrix/matrix.mtx")
...
my_dir_S <- "~/Lab_Data/SoupX/Waterson_300_lane1/"
...
# Top 8 genes: his-24, hil-2, ttr-50, T05E11.9, dpy-14, rpl-12, hil-7, atp-6
...
# Selected genes: ttr-50 dpy-14 sqt-3 pat-10 clik-1 cpn-3 hil-7
...
est.cont <- s2i(c("ttr-50", "dpy-14", "sqt-3", "pat-10", "clik-1", "cpn-3", "hil-7"), gids)
...
# Estimated global contamination fraction of 21.83
# Without ttr-60: only 8.16%
...
# 3826 genes passed tf-idf cut-off and 1965 soup quantile filter.  Taking the top 100.
# Using 2859 independent estimates of rho.
...
saveRDS(scl.sce, "~/Lab_Data/SoupX/Waterson_300_lane1/Waterson_300_lane1_soupX_object.rds")
saveRDS(soup.out, "~/Lab_Data/SoupX/Waterson_300_lane1/Waterson_300_lane1_soupX_corrected_matrix.rds")
...
# Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
# 0.000   2.528   3.414   4.080   4.558  41.614


summary(sce_corrected$subsets_Mito_percent)
# Min.  1st Qu.  Median    Mean 3rd Qu.    Max. 
#0.000   2.220   3.315   4.103   4.755  44.252 
...
sce
saveRDS(sce, "~/Lab_Data/SoupX/Waterson_300_lane1/Waterson_300_lane1_sce_uncorrected.rds")

sizeFactors(sce_corrected) <- librarySizeFactors(sce_corrected)
sce_corrected <- logNormCounts(sce_corrected)
sce_corrected
saveRDS(sce_corrected, "~/Lab_Data/SoupX/Waterson_300_lane1/Waterson_300_lane1_sce_SoupX_corrected.rds")
