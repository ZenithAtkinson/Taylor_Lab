...
table(W500$Sample)
W500_lane3 <- W500[, W500$Sample == "3"] # Selecting lane3
table(W500_lane3$Sample)
...
my_path <- "~/Lab_Data/Original_Files/Waterston_500_min_batch_1_10X_lane_3/raw_feature_bc_matrix/"
...
# 0.0     0.0     0.0     0.01    0.00    1.00  238170 

summary(emptydrops.out$FDR <= 0.01)
#  Mode   FALSE    TRUE    NA's
#logical  26    1343  238170 
...
# top 15 genes here
# "C02E7.6"  "hil-7"    "sqt-3"    "dpy-14"   "cut-2"    "pat-10"   "rpl-12"   "T05E11.9" "cpn-3"   
# "atp-6"    "nduo-6"   "rpl-7A"   "ctc-2"    "T05H10.3" "act-4"     
...
# Extract the barcode
barcodes_cedata = (pData(W500_lane3)$Cell)
...
sce_walkthrough$matching_barcodes <- paste(substring(sce_walkthrough$Barcode, 1, 17), "500.1.3", sep = "")
head(colData(sce_walkthrough))
...
# AT THIS POINT: We need to take all of their metadata present in head(pData(W400_lane3)) (like cell.type, cell.subtype, plot.cell.type), and 
...
metadata_W500_lane3 <- pData(W500_lane3)
head(metadata_W500_lane3)
...
library(Matrix)
#counts
writeMM(sce_filtered.filt.counts, "~/Lab_Data/SoupX/Waterson_500_lane3_batch1/filtered_feature_bc_matrix/matrix.mtx")
system("gzip ~/Lab_Data/SoupX/Waterson_500_lane3_batch1/filtered_feature_bc_matrix/matrix.mtx")
writeMM(sce_filtered.filt.counts, "~/Lab_Data/SoupX/Waterson_500_lane3_batch1/filtered_feature_bc_matrix/matrix.mtx")

#barcodes
fil.barcodes <- colnames(sce_filtered)
write.table(fil.barcodes, "~/Lab_Data/SoupX/Waterson_500_lane3_batch1/filtered_feature_bc_matrix/barcodes.tsv", 
            sep = "\t", quote = FALSE, col.names = FALSE, row.names = FALSE)
system("gzip ~/Lab_Data/SoupX/Waterson_500_lane3_batch1/filtered_feature_bc_matrix/barcodes.tsv")
write.table(fil.barcodes, "~/Lab_Data/SoupX/Waterson_500_lane3_batch1/filtered_feature_bc_matrix/barcodes.tsv", 
            sep = "\t", quote = FALSE, col.names = FALSE, row.names = FALSE)
...
# Seurat identified 13 clusters. There is good separation between the clusters
...
my_dir_S <- "~/Lab_Data/SoupX/Waterson_500_lane3_batch1/"
...
# Estimated global contamination fraction of 2.56%
...
# 4225 genes passed tf-idf cut-off and 2547 soup quantile filter.  Taking the top 100.
...
saveRDS(scl.sce, "~/Lab_Data/SoupX/Waterson_500_lane3_batch1/Waterson_500_lane3_batch1_soupX_object.rds")
saveRDS(soup.out, "~/Lab_Data/SoupX/Waterson_500_lane3_batch1/Waterson_500_lane3_batch1_soupX_corrected_matrix.rds")
...
# Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
# 0.000   2.169   3.204   4.179   4.641  84.444 

summary(sce_corrected$subsets_Mito_percent)
# Min.  1st Qu.  Median    Mean 3rd Qu.    Max. 
# 0.000   2.140   3.178   4.170   4.634  85.806 
...
sce
saveRDS(sce, "~/Lab_Data/SoupX/Waterson_500_lane3_batch1/Waterson_500_lane3_batch1_sce_uncorrected.rds")

sizeFactors(sce_corrected) <- librarySizeFactors(sce_corrected)
sce_corrected <- logNormCounts(sce_corrected)
sce_corrected
saveRDS(sce_corrected, "~/Lab_Data/SoupX/Waterson_500_lane3_batch1/Waterson_500_lane3_batch1_sce_SoupX_corrected.rds")
