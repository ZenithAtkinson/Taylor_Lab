...
table(W500$Sample)
W500_lane2 <- W500[, W500$Sample == "2"] # Selecting lane2
table(W500_lane2$Sample)
...
my_path <- "~/Lab_Data/Original_Files/Waterston_500_min_batch_2_10X_lane_2/raw_feature_bc_matrix/"
...
colData(sce_walkthrough)$Sample <- "2" # This denotes the lane/channel that it came from (specifically for 300, 400, 500)
...
# Opting for given_lower instead (333)
...
# 0.0     0.0     0.0     0.2     0.5     1.0  701501

summary(emptydrops.out$FDR <= 0.01)
#  Mode   FALSE    TRUE    NA's
#logical   10056   11261  701501 
...
# top 15 genes here
# "hil-7"    "pat-10"   "rpl-12"   "T05E11.9" "rla-1"    "dpy-14"  
# "cut-2"    "sqt-3"    "rpl-7A"   "atp-6"    "C02E7.6"  "eef-1A.1"
# "mlc-3"    "F07H5.3"  "cpn-3"  
...
# Extract the barcode
barcodes_cedata = (pData(W500_lane2)$Cell)
...
sce_walkthrough$matching_barcodes <- paste(substring(sce_walkthrough$Barcode, 1, 17), "500.2.2", sep = "")
head(colData(sce_walkthrough))
...
# AT THIS POINT: We need to take all of their metadata present in head(pData(W400_lane2)) (like cell.type, cell.subtype, plot.cell.type), and 
...
metadata_W500_lane2 <- pData(W500_lane2)
head(metadata_W500_lane2)
...
library(Matrix)
#counts
writeMM(sce_filtered.filt.counts, "~/Lab_Data/SoupX/Waterson_500_lane2_batch2/filtered_feature_bc_matrix/matrix.mtx")
system("gzip ~/Lab_Data/SoupX/Waterson_500_lane2_batch2/filtered_feature_bc_matrix/matrix.mtx")
writeMM(sce_filtered.filt.counts, "~/Lab_Data/SoupX/Waterson_500_lane2_batch2/filtered_feature_bc_matrix/matrix.mtx")

#barcodes
fil.barcodes <- colnames(sce_filtered)
write.table(fil.barcodes, "~/Lab_Data/SoupX/Waterson_500_lane2_batch2/filtered_feature_bc_matrix/barcodes.tsv", 
            sep = "\t", quote = FALSE, col.names = FALSE, row.names = FALSE)
system("gzip ~/Lab_Data/SoupX/Waterson_500_lane2_batch2/filtered_feature_bc_matrix/barcodes.tsv")
write.table(fil.barcodes, "~/Lab_Data/SoupX/Waterson_500_lane2_batch2/filtered_feature_bc_matrix/barcodes.tsv", 
            sep = "\t", quote = FALSE, col.names = FALSE, row.names = FALSE)
...
# Red = NEW data, blue is equal to old/combined data. Very little contamination
# Seurat identified 46 clusters. There is bad separation between the clusters
...
my_dir_S <- "~/Lab_Data/SoupX/Waterson_500_lane2_batch2/"
...
# Top 8 genes: hil-7, C02E7.6, sqt-3, dpy-14, cut-2, pat-10, rpl-12, T05E11.9
...
plotMarkerMap(scl.sce, s2i("ttr-50", gids)) #Good
...
# Selected genes: "dpy-14", "sqt-3", "pat-10", "clik-1", "cpn-3", "cut-2", "C02E7.6"
...
est.cont <- s2i(c("dpy-14", "sqt-3", "pat-10", "clik-1", "ttr-50", "cut-2", "nlp-77"), gids)
...
# Estimated global contamination fraction of 22.10
...
# 7782 genes passed tf-idf cut-off and 4028 soup quantile filter.  Taking the top 100.
# Using 3368 independent estimates of rho.
...
saveRDS(scl.sce, "~/Lab_Data/SoupX/Waterson_500_lane2_batch2/Waterson_500_lane2_batch2_soupX_object.rds")
saveRDS(soup.out, "~/Lab_Data/SoupX/Waterson_500_lane2_batch2/Waterson_500_lane2_batch2_soupX_corrected_matrix.rds")
...
# Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
# 0.000   1.740   2.638   3.467   3.980  34.738 

summary(sce_corrected$subsets_Mito_percent)
# Min.  1st Qu.  Median    Mean 3rd Qu.    Max. 
# 0.000   1.125   2.158   3.227   3.770  41.515
...
sce
saveRDS(sce, "~/Lab_Data/SoupX/Waterson_500_lane2_batch2/Waterson_500_lane2_batch2_sce_uncorrected.rds")

sizeFactors(sce_corrected) <- librarySizeFactors(sce_corrected)
sce_corrected <- logNormCounts(sce_corrected)
sce_corrected
saveRDS(sce_corrected, "~/Lab_Data/SoupX/Waterson_500_lane2_batch2/Waterson_500_lane2_batch2_sce_SoupX_corrected.rds")
